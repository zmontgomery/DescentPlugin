...
public class Monkey extends Champ {
	...
	public static final ItemStack[] ITEMS = new ItemStack[] { null, new ItemStack(Material.CROSSBOW), new ItemStack(Material.GOLDEN_BOOTS)};
	public static final ItemStack[] CLOTHES = new ItemStack[] { new ItemStack(Material.LEATHER_BOOTS), null, null, null};
	...
	public static final int SHOOT_DAMAGE = 60;
	public static final int PUNCH_DAMAGE = 12;
	
	public static final float MELEE_COOLDOWN = 0.2f;
	public static final float SHOOT_COOLDOWN = 2.0f;
	public static final float BANANA_COOLDOWN = 3.0f;
	
	public static final long GUN_CHARGE_TIME = 1;
	...
	public void use(Action click) {
		if (PLAYER.getInventory().getItemInMainHand().getType() == Material.CROSSBOW
			...
			Bukkit.getScheduler().runTaskLater(Main.getPlugin(Main.class), timer, GUN_CHARGE_TIME * 20);
